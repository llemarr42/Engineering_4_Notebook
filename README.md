...
#### for place in range(len(word)):    #repeat for every character in word ; place is a variable that represents each run through, so one the first run place=1 and the second =2...
